import * as CytoscapeApi from "./cy"
import * as Popup from "./popup"
import * as SimHandler from "./simhandler"
...
export class Main {
	...
	private sim: SimHandler.SimHandler;
	...
	constructor() {
		...
		this.sim = new SimHandler.SimHandler();
	...
	private simProgress(progress: SimHandler.ProgressInfo): void {
